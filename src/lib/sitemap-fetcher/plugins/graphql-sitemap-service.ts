...
import { ExtendedSitemapService } from '../extended-sitemap-service';
...
class GraphqlSitemapServicePlugin implements SitemapFetcherPlugin {
  ...
  constructor() {
    this._graphqlSitemapService = new ExtendedSitemapService({
      ...
      rootItemId: '{GUID}'
      */
      rootItemId: '{E7B56BEA-0658-44EF-AC69-48DBE5F29DC2}',
      /*
      Use excludeItemId or excludeTemplateId for extended sitemap service to reduce static pages build time
      */
      excludeItemId:
        process.env.SITECORE_BUILD_EXCLUDE_ITEMID || '{00000000-0000-0000-0000-000000000000}',
      excludeTemplateId:
        process.env.SITECORE_BUILD_EXCLUDE_TEMPLATEID || '{00000000-0000-0000-0000-000000000000}',
      pageSize: 100,
    });
  }
